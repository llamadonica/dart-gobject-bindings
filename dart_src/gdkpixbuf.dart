...
class Pixbuf extends GObjectObject with Icon, LoadableIcon {
  ...
  void set bitsPerSample(int value) => _staticInfo.setGPropertyOnReceiver('bits-per-sample', this, value);
  static const String BITS_PER_SAMPLE_PROPERTY = 'bits-per-sample';
  void set colorspace(Colorspace value) => _staticInfo.setGPropertyOnReceiver('colorspace', this, value);
  static const String COLORSPACE_PROPERTY = 'colorspace';
  void set hasAlpha(bool value) => _staticInfo.setGPropertyOnReceiver('has-alpha', this, value);
  ...
  void set nChannels(int value) => _staticInfo.setGPropertyOnReceiver('n-channels', this, value);
  static const String N_CHANNELS_PROPERTY = 'n-channels';
  Bytes get pixelBytes => _staticInfo.getGPropertyOnReceiver('pixel-bytes', this);
  void set pixelBytes(Bytes value) => _staticInfo.setGPropertyOnReceiver('pixel-bytes', this, value);
  static const String PIXEL_BYTES_PROPERTY = 'pixel-bytes';
  void set pixels(dynamic value /* this will fail */) => _staticInfo.setGPropertyOnReceiver('pixels', this, value);
  static const String PIXELS_PROPERTY = 'pixels';
  void set rowstride(int value) => _staticInfo.setGPropertyOnReceiver('rowstride', this, value);

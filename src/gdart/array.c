    ...
    GError **error)
{
  ...
  if (G_UNLIKELY (!base_info_klass->retrieve_wrapping_class (base_info,
                  self,
                  namespace_,
                  &wrapper,
                  dart_error_out,
  ...
  GError **error)
{
  ...
  for (; is_null_terminated || elem_i < length; elem_i++) {
    ...
    if (!gdart_array_load_element (self,
                                    name_prefix,
                                    param_type,
                                    param_type_klass,
                                    is_null_terminated,

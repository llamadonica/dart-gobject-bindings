...
static gboolean _gdart_g_property_fill_boolean (
...
static gboolean _gdart_g_property_fill_int_raw (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  gint64 raw_result,
  guint64 uraw_value,
...
static gboolean _gdart_g_property_fill_int (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  Dart_Handle dart_value,
  GValue *value,
...
static gboolean _gdart_g_property_fill_num (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  Dart_Handle dart_value,
  GValue *value,
...
static gboolean _gdart_g_property_fill_string (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  Dart_Handle dart_value,
  GValue *value,
...
static gboolean _gdart_g_property_fill_wrapped_pointer (
  GdartBridgeContext *self,
  const gchar *name_prefix,
...
static gboolean _gdart_g_property_fill_enum (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  const gchar *property_name,
  Dart_Handle dart_value,
...
static gboolean _gdart_g_property_unfill_array (
  GdartBridgeContext *self,
  GITypeInfo *arg_type,
  gpointer user_data,
  Dart_Handle *dart_error_out,
...
static gboolean _gdart_g_property_fill_array (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  const gchar *property_name,
  Dart_Handle dart_value,
  ...
  GError **error)
{
  ...
  param_type = g_type_info_get_param_type(arg_type, 0);
  size_of_element = gdart_array_get_size_multiplier (self,
                    param_type,
                    &gi_type_info_type_info,
                    dart_error_out,
                    error);
  ...
  buffer = g_malloc (allocation_length * size_of_element);
  ...
  array_record->array_length = allocation_length * size_of_element;
...
static gboolean _gdart_g_property_fill_object (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  Dart_Handle dart_value,
  GValue *value,
...
static gboolean _gdart_g_property_fill_interface (
  GdartBridgeContext *self,
  const gchar *name_prefix,
  const gchar *property_name,
  Dart_Handle dart_value,
...
static gboolean _gdart_g_property_unfill_value (
  GdartBridgeContext *self,
...
static gboolean _gdart_g_property_fill_value (
  GdartBridgeContext *self,
  const gchar *property_name,
  const gchar *name_prefix,
  GObject *object,
  ...
  GError **error)
{
  ...
  namespace_ = g_base_info_get_namespace ( (GIBaseInfo *) registered_type_info);
